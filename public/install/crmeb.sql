...
CREATE TABLE `eb_article` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='文章管理表';

-- ----------------------------
--  Records of `eb_article`
-- ----------------------------
BEGIN;
INSERT INTO `eb_article` VALUES ('1', '1', 'CRMEB微信公众号小程序用户管理+电商系统', 'honor', 'http://git.crmeb.net/uploads/editor/20180929/s_5baf3f4046bfa.png', 'CRMEB 是基于Thinkphp5基础开发的以会员为中心的电商系统，开源版微信公众号商城和小程序商城数据同步，带积分、优惠券、秒杀、砍价、分销等功能，更是一套方便二次开发的商城框架（后台封装了独有快速创建表单功能，无需写表单页面、快速创建数据搜索和数据列表页、导出表格、系统权限配置控制每一个控制器方法、系统参数配置、数据字典、组合数据等）', null, null, '0', '0', '', '1', '1537955495', '0', '1', '0', '0', '0'), ('2', '1', 'CrmEb v2.5微信公众号和小程序电商系统', 'admin', 'http://git.crmeb.net/uploads/editor/20181011/s_5bbea56a2c4b5.jpg', 'crmeb', null, null, null, '0', null, '1', '1539259830', '0', '0', '0', '0', '0'), ('3', '2,3', 'CRMEB微信公众号小程序用户管理+电商系统', 'honor', 'http://git.crmeb.net/uploads/0/20180929/s_5baf3ec199778.png', 'CRMEB微信公众号小程序用户管理+电商系统', null, null, '0', '0', '', '1', '1538208267', '0', '1', '0', '0', '1'), ('4', '2', '文章标题儿2', 'admin1', 'http://git.crmeb.net/uploads/0/20180929/s_5baf3ec199778.png', '文章标题儿1213', null, null, '0', '0', '', '0', '1538275495', '0', '0', '0', '0', '1'), ('5', '2', '文章标题', 'admin', 'http://git.crmeb.net/uploads/editor/20180929/s_5baf3f4046bfa.png', '文章简介', null, null, '0', '0', '', '1', '1539220850', '0', '1', '0', '1', '1');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `eb_article_category` VALUES ('1', '0', '公司新闻', '公司新闻', '', '1', '0', '0', '1537955392', '0'), ('2', '0', '行业新闻', '行业新闻', '', '1', '0', '0', '1537957558', '0'), ('3', '0', '关于我们', '关于我们', '', '1', '0', '0', '1537958082', '0');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `eb_store_cart` VALUES ('1', '1', 'product', '1', '0', '1', '1539253281', '1', '0', '1', '0', '0', '0');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `eb_store_order` VALUES ('1', 'wx2018101119062710001', '1', '张三', '13800000000', '北京 昌平区 城区以外 天安门广场', '[1]', '1', '10.00', '0.00', '10.00', '0.00', '0.00', '0', '0.00', '0', null, 'weixin', '1539255987', '0', '0', null, null, null, null, null, '0.00', null, null, null, '0.00', '0.00', null, '', '0', '9d7f6ea73bd786e63fc1a6aaa6cc1562', null, '0', '0', '0', '0', '10.00', '0', '0', '0');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `eb_store_order_cart_info` VALUES ('1', '1', '1', '{\"id\":1,\"uid\":1,\"type\":\"product\",\"product_id\":1,\"product_attr_unique\":\"0\",\"cart_num\":1,\"add_time\":1539253281,\"is_pay\":0,\"is_del\":0,\"is_new\":1,\"combination_id\":0,\"seckill_id\":0,\"bargain_id\":0,\"productInfo\":{\"id\":1,\"image\":\"http:\\/\\/git.crmeb.net\\/uploads\\/editor\\/20180929\\/s_5baf3f4046bfa.png\",\"slider_image\":[\"http:\\/\\/git.crmeb.net\\/uploads\\/editor\\/20180929\\/s_5baf3f4046bfa.png\"],\"price\":\"10.00\",\"cost\":\"10.00\",\"ot_price\":\"10.00\",\"vip_price\":\"0.00\",\"postage\":\"0.00\",\"mer_id\":0,\"give_integral\":\"0.00\",\"cate_id\":\"3\",\"sales\":10,\"stock\":1,\"store_name\":\"\\u6d4b\\u8bd5\\u6d4b\\u8bd5\",\"unit_name\":\"\\u4ef6\",\"is_show\":1,\"is_del\":0,\"is_postage\":1},\"truePrice\":10,\"costPrice\":10,\"trueStock\":1}', '6512bd43d9caa6e02c990b0a82652dca');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `eb_store_order_status` VALUES ('1', 'cache_key_create_order', '订单生成', '1539255987');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `eb_store_product` VALUES ('1', '0', 'http://git.crmeb.net/uploads/editor/20180929/s_5baf3f4046bfa.png', '[\"http:\\/\\/git.crmeb.net\\/uploads\\/editor\\/20180929\\/s_5baf3f4046bfa.png\"]', '测试测试', '测试测试测试测试测试测试', '测试测试', '3', '10.00', '0.00', '10.00', '0.00', '件', '10', '11', '0', '1', '1', '1', '1', '1', '', '1534818410', '1', '0', '0', '0.00', '10.00', '0', '0', '1010', '0', '');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `eb_store_product_relation` VALUES ('1', '1', 'like', 'product', '1539262025');
COMMIT;
...
CREATE TABLE `eb_store_service` (
  ...
  `status` tinyint(1) unsigned DEFAULT '1' COMMENT '0隐藏1显示',
...
-- ----------------------------
BEGIN;
INSERT INTO `eb_store_service` VALUES ('1', '0', '90', 'http://thirdwx.qlogo.cn/mmopen/LneiciaJhByic2MV0ocMFdPHJzlaWskqtgN5qCAojya1LHbjlhIHzWOBehN78WTuAqUjOnUUbSpJKpYJlaysap1HUpfzeQg0ugP/132', '天会亮、心会暖', '1528681446', '1', '0'), ('9', '0', '1', 'http://thirdwx.qlogo.cn/mmopen/ajNVdqHZLLCx03Y4hkSeVgQZGZLYDSQz6SZ7PDDNSLj3RxVPYqibMvW4cIOicPSSmA0xbrL9DY2RkunA1pulAs9g/132', '等风来，随风去', '1534312905', '1', '1');
COMMIT;
...
CREATE TABLE `eb_store_service_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=47 DEFAULT CHARSET=utf8 COMMENT='客服用户对话记录表';

-- ----------------------------
--  Records of `eb_store_service_log`
-- ----------------------------
BEGIN;
INSERT INTO `eb_store_service_log` VALUES ('46', '0', '[感觉真好]', '1', '90', '1539256049', null, null);
COMMIT;
...
CREATE TABLE `eb_store_visit` (
  ...
  `add_time` int(11) DEFAULT NULL COMMENT '添加时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='产品浏览分析表';

-- ----------------------------
--  Records of `eb_store_visit`
-- ----------------------------
BEGIN;
INSERT INTO `eb_store_visit` VALUES ('1', '0', 'product', '0', 'search', '1', '1', '0', '1535070682'), ('2', '0', 'product', '0', 'search', '1', '1', '0', '1537107012'), ('3', '1', 'product', '0', 'viwe', '1', '7', '', '1540528339'), ('4', '0', 'product', '0', 'search', '1', '1', '0', '1538295510'), ('5', '0', 'product', '0', 'search', '1', '1', '0', '1539253275');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `eb_system_admin` VALUES ('1', 'admin', '6b94a88632e2577a60f64520998d11c9', 'admin', '1', '123.139.160.193', '1543388581', '1537082825', '0', '0', '1', '0');
COMMIT;
...
CREATE TABLE `eb_system_attachment` (
  ...
  PRIMARY KEY (`att_id`)
) ENGINE=InnoDB AUTO_INCREMENT=85 DEFAULT CHARSET=utf8 COMMENT='附件管理表';

-- ----------------------------
--  Records of `eb_system_attachment`
-- ----------------------------
BEGIN;
INSERT INTO `eb_system_attachment` VALUES ('70', '5baf3ec199778.png', '/uploads/0/20180929/5baf3ec199778.png', '/uploads/0/20180929/s_5baf3ec199778.png', '106073', 'image/png', '0', '1538211521'), ('72', '5baf3f4046bfa.png', '/uploads/editor/20180929/5baf3f4046bfa.png', '/uploads/editor/20180929/s_5baf3f4046bfa.png', '607296', 'image/png', '0', '1538211648'), ('73', '5baf4045dc146.png', '/uploads/editor/20180929/5baf4045dc146.png', '/uploads/editor/20180929/s_5baf4045dc146.png', '106073', 'image/png', '0', '1538211909'), ('74', '5bbea56a2c4b5.jpg', '/uploads/editor/20181011/5bbea56a2c4b5.jpg', '/uploads/editor/20181011/s_5bbea56a2c4b5.jpg', '354299', 'image/jpeg', '0', '1539220842'), ('75', '5bbf3349f1c87.png', '/uploads/12/20181011/5bbf3349f1c87.png', '/uploads/12/20181011/s_5bbf3349f1c87.png', '1558', 'image/png', '12', '1539257161'), ('76', '5bbf334a04a21.png', '/uploads/12/20181011/5bbf334a04a21.png', '/uploads/12/20181011/s_5bbf334a04a21.png', '3451', 'image/png', '12', '1539257162'), ('77', '5bbf334a0cace.png', '/uploads/12/20181011/5bbf334a0cace.png', '/uploads/12/20181011/s_5bbf334a0cace.png', '2875', 'image/png', '12', '1539257162'), ('78', '5bbf334a16c68.png', '/uploads/12/20181011/5bbf334a16c68.png', '/uploads/12/20181011/s_5bbf334a16c68.png', '2130', 'image/png', '12', '1539257162'), ('79', '5bbf334a1d83f.png', '/uploads/12/20181011/5bbf334a1d83f.png', '/uploads/12/20181011/s_5bbf334a1d83f.png', '1559', 'image/png', '12', '1539257162'), ('80', '5bbf334a24333.png', '/uploads/12/20181011/5bbf334a24333.png', '/uploads/12/20181011/s_5bbf334a24333.png', '1569', 'image/png', '12', '1539257162'), ('81', '5bbf334a2ae17.png', '/uploads/12/20181011/5bbf334a2ae17.png', '/uploads/12/20181011/s_5bbf334a2ae17.png', '1576', 'image/png', '12', '1539257162'), ('82', '5bbf334a31840.png', '/uploads/12/20181011/5bbf334a31840.png', '/uploads/12/20181011/s_5bbf334a31840.png', '1869', 'image/png', '12', '1539257162'), ('83', '5bbf334a38504.png', '/uploads/12/20181011/5bbf334a38504.png', '/uploads/12/20181011/s_5bbf334a38504.png', '2639', 'image/png', '12', '1539257162'), ('84', '5be008e906144.jpg', '/uploads/0/20181105/5be008e906144.jpg', '/uploads/0/20181105/s_5be008e906144.jpg', '40815', 'image/jpeg', '0', '1541409001');
COMMIT;
...
CREATE TABLE `eb_system_attachment_category` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COMMENT='附件分类表';

-- ----------------------------
--  Records of `eb_system_attachment_category`
-- ----------------------------
BEGIN;
INSERT INTO `eb_system_attachment_category` VALUES ('1', '0', '产品图片', 'product'), ('2', '0', '新闻图片', 'news'), ('3', '0', '配置图片', 'config'), ('4', '3', '首页导航', 'indexnav'), ('5', '3', '首页幻灯片', 'mynav'), ('7', '2', '公司新闻', 'compay'), ('11', '1', '数码产品', ''), ('12', '3', '个人中心图标', ''), ('13', '0', '123', ''), ('14', '0', '21312', ''), ('15', '0', 'ewqe', ''), ('16', '0', 'weqwe', ''), ('17', '0', 'wqeqwe', '');
COMMIT;
...
) ENGINE=MyISAM AUTO_INCREMENT=51 DEFAULT CHARSET=utf8 COMMENT='组合数据表';

-- ----------------------------
--  Records of `eb_system_group`
-- ----------------------------
BEGIN;
INSERT INTO `eb_system_group` VALUES ('32', '个人中心菜单', '个人中心菜单设置', 'my_index_menu', '[{\"name\":\"\\u540d\\u79f0\",\"title\":\"name\",\"type\":\"input\",\"param\":\"\"},{\"name\":\"\\u56fe\\u6807\",\"title\":\"icon\",\"type\":\"upload\",\"param\":\"\"},{\"name\":\"\\u94fe\\u63a5\",\"title\":\"url\",\"type\":\"select\",\"param\":\"\\/wap\\/my\\/integral.html=>\\u6211\\u7684\\u79ef\\u5206\\n\\/wap\\/my\\/coupon.html=>\\u4f18\\u60e0\\u5238\\n\\/wap\\/my\\/collect.html=>\\u6536\\u85cf\\u5217\\u8868\\n\\/wap\\/my\\/address.html=>\\u5730\\u5740\\u7ba1\\u7406\\n\\/wap\\/my\\/balance.html=>\\u6211\\u7684\\u4f59\\u989d\\n\\/wap\\/service\\/service_new.html=>\\u804a\\u5929\\u8bb0\\u5f55\\n\\/wap\\/index\\/about.html=>\\u8054\\u7cfb\\u6211\\u4eec\\n\\/wap\\/my\\/user_pro.html=>\\u63a8\\u5e7f\\u4f63\\u91d1\"}]'), ('34', '商城首页banner', '商城首页banner设置', 'store_home_banner', '[{\"name\":\"\\u6807\\u9898\",\"title\":\"title\",\"type\":\"input\",\"param\":\"\"},{\"name\":\"\\u94fe\\u63a5\",\"title\":\"url\",\"type\":\"input\",\"param\":\"\"},{\"name\":\"\\u56fe\\u7247\",\"title\":\"pic\",\"type\":\"upload\",\"param\":\"\"}]'), ('35', '商城首页分类按钮', '商城首页分类按钮', 'store_home_menus', '[{\"name\":\"\\u540d\\u79f0\",\"title\":\"name\",\"type\":\"input\",\"param\":\"\"},{\"name\":\"\\u94fe\\u63a5\",\"title\":\"url\",\"type\":\"select\",\"param\":\"\\/wap\\/my\\/integral.html=\\u6211\\u7684\\u79ef\\u5206\\n\\/wap\\/my\\/coupon.html=\\u4f18\\u60e0\\u5238\\n\\/wap\\/my\\/collect.html=\\u6536\\u85cf\\u5217\\u8868\\n\\/wap\\/my\\/address.html=\\u5730\\u5740\\u7ba1\\u7406\\n\\/wap\\/my\\/balance.html=\\u6211\\u7684\\u4f59\\u989d\\n\\/wap\\/service\\/service_new.html=\\u804a\\u5929\\u8bb0\\u5f55\\n\\/wap\\/index\\/about.html=\\u8054\\u7cfb\\u6211\\u4eec\\n\\/wap\\/my\\/user_pro.html=\\u63a8\\u5e7f\\u4f63\\u91d1\"},{\"name\":\"\\u56fe\\u6807\",\"title\":\"icon\",\"type\":\"upload\",\"param\":\"\"}]'), ('36', '商城首页滚动新闻', '商城首页滚动新闻', 'store_home_roll_news', '[{\"name\":\"\\u6eda\\u52a8\\u6587\\u5b57\",\"title\":\"info\",\"type\":\"input\",\"param\":\"\"},{\"name\":\"\\u70b9\\u51fb\\u94fe\\u63a5\",\"title\":\"url\",\"type\":\"input\",\"param\":\"\"}]'), ('37', '小程序首页猜你喜欢banner', '小程序首页猜你喜欢banner', 'routine_lovely', '[{\"name\":\"\\u56fe\\u7247\",\"title\":\"img\",\"type\":\"upload\",\"param\":\"\"}]'), ('47', '小程序商城首页分类按钮', '小程序商城首页分类按钮', 'routine_home_menus', '[{\"name\":\"\\u5206\\u7c7b\\u540d\\u79f0\",\"title\":\"name\",\"type\":\"input\",\"param\":\"\"},{\"name\":\"\\u5206\\u7c7b\\u56fe\\u6807\",\"title\":\"pic\",\"type\":\"upload\",\"param\":\"\"},{\"name\":\"\\u8df3\\u8f6c\\u8def\\u5f84\",\"title\":\"url\",\"type\":\"select\",\"param\":\"\\/pages\\/index\\/index=>\\u5546\\u57ce\\u9996\\u9875\\n\\/pages\\/spread\\/spread=>\\u4e2a\\u4eba\\u63a8\\u5e7f\\n\\/pages\\/coupon\\/coupon=>\\u4f18\\u60e0\\u5238\\n\\/pages\\/user\\/user=>\\u4e2a\\u4eba\\u4e2d\\u5fc3\\n\\/pages\\/miao-list\\/miao-list=>\\u79d2\\u6740\\u5217\\u8868\\n\\/pages\\/pink-list\\/index=>\\u62fc\\u56e2\\u5217\\u8868\\u9875\\n\\/pages\\/cut-list\\/cut-list?id=123=>\\u780d\\u4ef7\\u5217\\u8868\\n\\/pages\\/productSort\\/productSort=>\\u5206\\u7c7b\\u9875\\u9762\\n\\/pages\\/address\\/address=>\\u5730\\u5740\\u5217\\u8868\\n\\/pages\\/cash\\/cash=>\\u63d0\\u73b0\\u9875\\u9762\\n\\/pages\\/extension\\/extension=>\\u63a8\\u5e7f\\u7edf\\u8ba1\\n\\/pages\\/main\\/main=>\\u8d26\\u6237\\u91d1\\u989d\\n\\/pages\\/collect\\/collect=>\\u6211\\u7684\\u6536\\u85cf\\n\\/pages\\/promotion-card\\/promotion-card=>\\u63a8\\u5e7f\\u4e8c\\u7ef4\\u7801\\u9875\\u9762\\n\\/pages\\/buycar\\/buycar=>\\u8d2d\\u7269\\u8f66\\u9875\\u9762\\n\\/pages\\/news-list\\/news-list=>\\u6d88\\u606f\\u5217\\u8868\\u9875\\n\\/pages\\/orders-list\\/orders-list=>\\u8ba2\\u5355\\u5217\\u8868\\u9875\\u9762\\n\\/pages\\/new-list\\/new-list=>\\u6587\\u7ae0\\u5217\\u8868\\u9875\"},{\"name\":\"\\u5e95\\u90e8\\u83dc\\u5355\",\"title\":\"show\",\"type\":\"radio\",\"param\":\"\\u662f=>\\u662f\\n\\u5426=>\\u5426\"}]'), ('48', '小程序商城首页banner', '小程序商城首页banner', 'routine_home_banner', '[{\"name\":\"\\u6807\\u9898\",\"title\":\"name\",\"type\":\"input\",\"param\":\"\"},{\"name\":\"\\u94fe\\u63a5\",\"title\":\"url\",\"type\":\"select\",\"param\":\"\\/pages\\/index\\/index=\\u5546\\u57ce\\u9996\\u9875\\n\\/pages\\/spread\\/spread=\\u4e2a\\u4eba\\u63a8\\u5e7f\\n\\/pages\\/coupon\\/coupon=\\u4f18\\u60e0\\u5238\\n\\/pages\\/user\\/user=\\u4e2a\\u4eba\\u4e2d\\u5fc3\\n\\/pages\\/miao-list\\/miao-list=\\u79d2\\u6740\\u5217\\u8868\\n\\/pages\\/pink-list\\/index=\\u62fc\\u56e2\\u5217\\u8868\\u9875\\n\\/pages\\/cut-list\\/cut-list=\\u780d\\u4ef7\\u5217\\u8868\\n\\/pages\\/productSort\\/productSort=\\u5206\\u7c7b\\u9875\\u9762\\n\\/pages\\/address\\/address=\\u5730\\u5740\\u5217\\u8868\\n\\/pages\\/cash\\/cash=\\u63d0\\u73b0\\u9875\\u9762\\n\\/pages\\/extension\\/extension=\\u63a8\\u5e7f\\u7edf\\u8ba1\\n\\/pages\\/main\\/main=\\u8d26\\u6237\\u91d1\\u989d\\n\\/pages\\/collect\\/collect=\\u6211\\u7684\\u6536\\u85cf\\n\\/pages\\/promotion-card\\/promotion-card=\\u63a8\\u5e7f\\u4e8c\\u7ef4\\u7801\\u9875\\u9762\\n\\/pages\\/buycar\\/buycar=\\u8d2d\\u7269\\u8f66\\u9875\\u9762\\n\\/pages\\/news-list\\/news-list=\\u6d88\\u606f\\u5217\\u8868\\u9875\\n\\/pages\\/orders-list\\/orders-list=\\u8ba2\\u5355\\u5217\\u8868\\u9875\\u9762\\n\\/pages\\/new-list\\/new-list=\\u6587\\u7ae0\\u5217\\u8868\\u9875\"},{\"name\":\"\\u56fe\\u7247\",\"title\":\"pic\",\"type\":\"upload\",\"param\":\"\"}]');
COMMIT;
...
CREATE TABLE `eb_system_group_data` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=111 DEFAULT CHARSET=utf8 COMMENT='组合数据详情表';

-- ----------------------------
--  Records of `eb_system_group_data`
-- ----------------------------
BEGIN;
INSERT INTO `eb_system_group_data` VALUES ('52', '32', '{\"name\":{\"type\":\"input\",\"value\":\"\\u6211\\u7684\\u79ef\\u5206\"},\"icon\":{\"type\":\"upload\",\"value\":\"http:\\/\\/git.crmeb.net\\/uploads\\/12\\/20181011\\/5bbf334a38504.png\"},\"url\":{\"type\":\"select\",\"value\":\"\\/wap\\/my\\/integral.html\"}}', '1513846430', '1', '1'), ('53', '32', '{\"name\":{\"type\":\"input\",\"value\":\"\\u4f18\\u60e0\\u5238\"},\"icon\":{\"type\":\"upload\",\"value\":\"http:\\/\\/git.crmeb.net\\/uploads\\/12\\/20181011\\/5bbf334a31840.png\"},\"url\":{\"type\":\"select\",\"value\":\"\\/wap\\/my\\/coupon.html\"}}', '1513846448', '1', '1'), ('84', '34', '{\"title\":{\"type\":\"input\",\"value\":\"banner3\"},\"url\":{\"type\":\"input\",\"value\":\"#\"},\"pic\":{\"type\":\"upload\",\"value\":\"http:\\/\\/shop.crmeb.net\\/public\\/uploads\\/11\\/20180817\\/5b7670c42f24b.jpg\"}}', '1522135667', '11', '1'), ('56', '32', '{\"name\":{\"type\":\"input\",\"value\":\"\\u5df2\\u6536\\u85cf\\u5546\\u54c1\"},\"icon\":{\"type\":\"upload\",\"value\":\"http:\\/\\/git.crmeb.net\\/uploads\\/12\\/20181011\\/5bbf334a1d83f.png\"},\"url\":{\"type\":\"select\",\"value\":\"\\/wap\\/my\\/collect.html\"}}', '1513846605', '1', '1'), ('57', '32', '{\"name\":{\"type\":\"input\",\"value\":\"\\u5730\\u5740\\u7ba1\\u7406\"},\"icon\":{\"type\":\"upload\",\"value\":\"http:\\/\\/git.crmeb.net\\/uploads\\/12\\/20181011\\/5bbf3349f1c87.png\"},\"url\":{\"type\":\"select\",\"value\":\"\\/wap\\/my\\/address.html\"}}', '1513846618', '1', '1'), ('87', '32', '{\"name\":{\"type\":\"input\",\"value\":\"\\u6211\\u7684\\u4f59\\u989d\"},\"icon\":{\"type\":\"upload\",\"value\":\"http:\\/\\/git.crmeb.net\\/uploads\\/12\\/20181011\\/5bbf334a2ae17.png\"},\"url\":{\"type\":\"select\",\"value\":\"\\/wap\\/my\\/balance.html\"}}', '1525330614', '1', '1'), ('67', '32', '{\"name\":{\"type\":\"input\",\"value\":\"\\u804a\\u5929\\u8bb0\\u5f55\"},\"icon\":{\"type\":\"upload\",\"value\":\"http:\\/\\/git.crmeb.net\\/uploads\\/12\\/20181011\\/5bbf334a24333.png\"},\"url\":{\"type\":\"select\",\"value\":\"\\/wap\\/service\\/service_new.html\"}}', '1515570261', '1', '1'), ('68', '34', '{\"title\":{\"type\":\"input\",\"value\":\"banner1\"},\"url\":{\"type\":\"input\",\"value\":\"#\"},\"pic\":{\"type\":\"upload\",\"value\":\"http:\\/\\/shop.crmeb.net\\/public\\/uploads\\/editor\\/20180601\\/5b10b2e4b6cf2.jpg\"}}', '1515984801', '10', '1'), ('69', '34', '{\"title\":{\"type\":\"input\",\"value\":\"banner2\"},\"url\":{\"type\":\"input\",\"value\":\"#\"},\"pic\":{\"type\":\"upload\",\"value\":\"http:\\/\\/shop.crmeb.net\\/public\\/uploads\\/editor\\/20180601\\/5b10b2aaa33d8.jpg\"}}', '1515984809', '9', '2'), ('71', '35', '{\"name\":{\"type\":\"input\",\"value\":\"\\u780d\\u4ef7\\u6d3b\\u52a8\"},\"url\":{\"type\":\"input\",\"value\":\"\\/wap\\/store\\/cut_list.html\"},\"icon\":{\"type\":\"upload\",\"value\":\"http:\\/\\/shop.crmeb.net\\/public\\/uploads\\/0\\/20180809\\/5b6c0c5fdaae5.png\"}}', '1515985418', '1', '1'), ('72', '35', '{\"name\":{\"type\":\"input\",\"value\":\"\\u9886\\u5238\\u4e2d\\u5fc3\"},\"url\":{\"type\":\"input\",\"value\":\"\\/wap\\/store\\/issue_coupon.html\"},\"icon\":{\"type\":\"upload\",\"value\":\"http:\\/\\/shop.crmeb.net\\/public\\/uploads\\/0\\/20180809\\/5b6c0e995f6d4.png\"}}', '1515985426', '1', '1'), ('74', '35', '{\"name\":{\"type\":\"input\",\"value\":\"\\u6bcf\\u65e5\\u7b7e\\u5230\"},\"url\":{\"type\":\"input\",\"value\":\"\\/wap\\/my\\/sign_in.html\"},\"icon\":{\"type\":\"upload\",\"value\":\"http:\\/\\/shop.crmeb.net\\/public\\/uploads\\/0\\/20180809\\/5b6c0c5fe73e6.png\"}}', '1515985441', '1', '1'), ('80', '36', '{\"info\":{\"type\":\"input\",\"value\":\"CRMEB\\u7535\\u5546\\u7cfb\\u7edf V 2.5 \\u5373\\u5c06\\u4e0a\\u7ebf\\uff01\"},\"url\":{\"type\":\"input\",\"value\":\"#\"}}', '1515985907', '1', '1'), ('81', '36', '{\"info\":{\"type\":\"input\",\"value\":\"CRMEB\\u5546\\u57ce V 2.5 \\u5c0f\\u7a0b\\u5e8f\\u516c\\u4f17\\u53f7\\u6570\\u636e\\u540c\\u6b65\\uff01\"},\"url\":{\"type\":\"input\",\"value\":\"#\"}}', '1515985918', '1', '1'), ('107', '37', '{\"img\":{\"type\":\"upload\",\"value\":\"http:\\/\\/shop.crmeb.net\\/public\\/uploads\\/8\\/20180817\\/5b768dfd6189a.jpg\"}}', '1534496260', '0', '1'), ('88', '37', '{\"img\":{\"type\":\"upload\",\"value\":\"http:\\/\\/shop.crmeb.net\\/public\\/uploads\\/editor\\/20180601\\/5b10b2b0969d7.jpg\"}}', '1526699754', '2', '1'), ('89', '38', '{\"banner\":{\"type\":\"upload\",\"value\":\"http:\\/\\/shop.crmeb.net\\/public\\/uploads\\/editor\\/20180601\\/5b10b2436876e.jpg\"}}', '1527153599', '1', '1'), ('86', '32', '{\"name\":{\"type\":\"input\",\"value\":\"\\u8054\\u7cfb\\u5ba2\\u670d\"},\"icon\":{\"type\":\"upload\",\"value\":\"http:\\/\\/git.crmeb.net\\/uploads\\/12\\/20181011\\/5bbf334a16c68.png\"},\"url\":{\"type\":\"select\",\"value\":\"\\/wap\\/index\\/about.html\"}}', '1522310836', '1', '1'), ('90', '34', '{\"title\":{\"type\":\"input\",\"value\":\"1\"},\"url\":{\"type\":\"input\",\"value\":\"#\"},\"pic\":{\"type\":\"upload\",\"value\":\"http:\\/\\/shop.crmeb.net\\/public\\/uploads\\/editor\\/20180601\\/5b10b2a4445a8.jpg\"}}', '1527823558', '1', '2'), ('91', '37', '{\"img\":{\"type\":\"upload\",\"value\":\"http:\\/\\/shop.crmeb.net\\/public\\/uploads\\/editor\\/20180601\\/5b10b2deb5b20.jpg\"}}', '1528688012', '1', '1'), ('92', '32', '{\"name\":{\"type\":\"input\",\"value\":\"\\u63a8\\u5e7f\\u4f63\\u91d1\"},\"icon\":{\"type\":\"upload\",\"value\":\"http:\\/\\/git.crmeb.net\\/uploads\\/12\\/20181011\\/5bbf334a04a21.png\"},\"url\":{\"type\":\"select\",\"value\":\"\\/wap\\/my\\/user_pro.html\"}}', '1530688244', '1', '1'), ('99', '47', '{\"name\":{\"type\":\"input\",\"value\":\"\\u5206\\u7c7b\"},\"pic\":{\"type\":\"upload\",\"value\":\"http:\\/\\/shop.crmeb.net\\/public\\/uploads\\/0\\/20180808\\/5b6ab28559200.png\"},\"url\":{\"type\":\"input\",\"value\":\"\\/pages\\/productSort\\/productSort\"},\"show\":{\"type\":\"radio\",\"value\":\"\\u662f\"}}', '1533721963', '1', '1'), ('101', '47', '{\"name\":{\"type\":\"input\",\"value\":\"\\u79d2\\u6740\"},\"pic\":{\"type\":\"upload\",\"value\":\"http:\\/\\/shop.crmeb.net\\/public\\/uploads\\/0\\/20180808\\/5b6abda83dc2a.png\"},\"url\":{\"type\":\"input\",\"value\":\"\\/pages\\/miao-list\\/miao-list\"},\"show\":{\"type\":\"radio\",\"value\":\"\\u5426\"}}', '1533722037', '1', '1'), ('103', '48', '{\"name\":{\"type\":\"input\",\"value\":\"banenr1\"},\"url\":{\"type\":\"input\",\"value\":\"\\/pages\\/miao-list\\/miao-list\"},\"pic\":{\"type\":\"upload\",\"value\":\"http:\\/\\/shop.crmeb.net\\/public\\/uploads\\/editor\\/20180601\\/5b10b2d35dc37.jpg\"}}', '1533722245', '1', '1'), ('104', '48', '{\"name\":{\"type\":\"input\",\"value\":\"banenr2\"},\"url\":{\"type\":\"input\",\"value\":\"\\/pages\\/pink-list\\/index\"},\"pic\":{\"type\":\"upload\",\"value\":\"http:\\/\\/shop.crmeb.net\\/public\\/uploads\\/11\\/20180817\\/5b7670c42f24b.jpg\"}}', '1533722286', '10', '1'), ('105', '47', '{\"name\":{\"type\":\"input\",\"value\":\"\\u54a8\\u8be2\"},\"pic\":{\"type\":\"upload\",\"value\":\"http:\\/\\/shop.crmeb.net\\/public\\/uploads\\/0\\/20180809\\/5b6bedbcb2f17.png\"},\"url\":{\"type\":\"input\",\"value\":\"\\/pages\\/new-list\\/new-list\"},\"show\":{\"type\":\"radio\",\"value\":\"\\u5426\"}}', '1533797064', '1', '1');
COMMIT;
...
CREATE TABLE `eb_system_log` (
  ...
  KEY `add_time` (`add_time`) USING BTREE,
  KEY `type` (`type`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=2832 DEFAULT CHARSET=utf8 COMMENT='管理员操作记录表';
...
-- ----------------------------
BEGIN;
INSERT INTO `eb_user` VALUES ('1', 'crmeb', 'e10adc3949ba59abbe56e057f20f883e', '等风来，随风去', 'http://thirdwx.qlogo.cn/mmopen/ajNVdqHZLLBaQPPnbg52bgibia1CZDruib1RwibHbBbnfxH1MUwbyz3G0Xub1LNX0ib5RFd7nZvo88gzHwib0OPibyfZQ/132', '', '1528859304', '140.207.54.80', '1542770910', '123.139.135.107', '0.00', '0.00', '1', '0', '0', 'wechat', '0', '0');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `eb_user_address` VALUES ('1', '1', '张三', '13800000000', '北京', '昌平区', '城区以外', '天安门广场', '0', '0', '0', '1', '0', '1539255976');
COMMIT;
...
CREATE TABLE `eb_wechat_news_category` (
  ...
  `add_time` varchar(255) NOT NULL COMMENT '添加时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='图文消息管理表';

-- ----------------------------
--  Records of `eb_wechat_news_category`
-- ----------------------------
BEGIN;
INSERT INTO `eb_wechat_news_category` VALUES ('1', 'CrmEb v2.5微信公众号和小程序电商系统', '0', '1', '2', '1539259830'), ('2', '文章标题儿', '0', '1', '4', '1538275495');
COMMIT;
...
) ENGINE=MyISAM AUTO_INCREMENT=127 DEFAULT CHARSET=utf8 COMMENT='微信二维码管理表';

-- ----------------------------
--  Records of `eb_wechat_qrcode`
-- ----------------------------
BEGIN;
INSERT INTO `eb_wechat_qrcode` VALUES ('126', 'spread', '1', 'gQFm8TwAAAAAAAAAAS5odHRwOi8vd2VpeGluLnFxLmNvbS9xLzAycG9JSGd5UDBiRy0xMDAwMHcwMzUAAgQ6sNlaAwQAAAAA', '0', '1', '1538276776', 'https://mp.weixin.qq.com/cgi-bin/showqrcode?ticket=gQFm8TwAAAAAAAAAAS5odHRwOi8vd2VpeGluLnFxLmNvbS9xLzAycG9JSGd5UDBiRy0xMDAwMHcwMzUAAgQ6sNlaAwQAAAAA', 'http://weixin.qq.com/q/02poIHgyP0bG-10000w035', '0');
COMMIT;
