...
('wechat_menus', '[{"type":"view","name":"\\u516c\\u4f17\\u53f7\\u5546\\u57ce","sub_button":[],"url":"http:\\/\\/datong.crmeb.net\\/wap"},{"type":"miniprogram","name":"\\u5c0f\\u7a0b\\u5e8f\\u5546\\u57ce","sub_button":[],"url":"pages\\/index\\/index","appid":"1111","pagepath":"pages\\/index\\/index"}]', 1552353930);
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='微信模板' AUTO_INCREMENT=25 ;
...
(1, 'admin', '6b94a88632e2577a60f64520998d11c9', 'admin', '1', '127.0.0.1', 1557384677, 1547630423, 0, 0, 1, 0);
...
CREATE TABLE IF NOT EXISTS `eb_system_file` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='文件对比表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `eb_system_log` (
  ...
  KEY `add_time` (`add_time`) USING BTREE,
  KEY `type` (`type`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='管理员操作记录表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `eb_user_group` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用户分组表' AUTO_INCREMENT=4 ;
...
CREATE TABLE IF NOT EXISTS `eb_user_level` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `id` (`id`) USING BTREE
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用户等级记录表' AUTO_INCREMENT=32 ;
...
(18, 95, 1, 1, 0, 1, 0, 1, '尊敬的用户天会亮、心会暖在2019-04-10 15:27:16成为了普通会员', 0, 0, 1554881236, 99),
(19, 6, 1, 1, 0, 1, 0, 1, '尊敬的用户弱冠而立_在2019-04-10 17:17:46成为了普通会员', 0, 0, 1554887866, 99),
(20, 46, 1, 1, 0, 1, 0, 1, '尊敬的用户张鹏飞在2019-04-10 17:18:46成为了普通会员', 0, 0, 1554887926, 99),
(21, 127, 1, 1, 0, 1, 0, 1, '尊敬的用户路人甲在2019-04-10 17:39:57成为了普通会员', 0, 0, 1554889197, 99),
(22, 4, 1, 1, 0, 1, 0, 1, '尊敬的用户徐斗明在2019-04-10 19:22:44成为了普通会员', 0, 0, 1554895364, 99),
(23, 313, 1, 1, 0, 1, 0, 1, '尊敬的用户啊丶饭在2019-04-10 19:22:48成为了普通会员', 0, 0, 1554895368, 99),
(24, 308, 1, 1, 0, 1, 0, 1, '尊敬的用户褚润林在2019-04-10 19:23:25成为了普通会员', 0, 0, 1554895405, 99),
(25, 2, 1, 1, 0, 1, 0, 1, '尊敬的用户༄许のོ࿆༘荣耀࿐在2019-04-11 09:58:16成为了普通会员', 0, 0, 1554947896, 99),
(27, 238, 1, 1, 0, 1, 0, 1, '尊敬的用户Mr .在2019-04-11 15:13:31成为了普通会员', 0, 0, 1554966811, 99),
(28, 82, 1, 1, 0, 1, 0, 1, '尊敬的用户等风来，随风去在2019-04-11 16:46:30成为了普通会员', 0, 0, 1554972390, 99),
(29, 312, 1, 1, 0, 1, 0, 1, '尊敬的用户Ricky คิดถึง在2019-04-12 12:53:38成为了普通会员', 0, 0, 1555044818, 99),
(30, 180, 1, 1, 0, 1, 0, 1, '尊敬的用户镇哥在2019-04-12 21:15:05成为了普通会员', 0, 0, 1555074905, 99),
(31, 27, 1, 1, 0, 1, 0, 1, '尊敬的用户梁海涛在2019-04-13 10:29:30成为了普通会员', 0, 0, 1555122570, 99);
