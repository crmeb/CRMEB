...
) ENGINE=MyISAM AUTO_INCREMENT=19 DEFAULT CHARSET=utf8 COMMENT='微信模板';
...
CREATE TABLE `eb_store_bargain` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='砍价表';
...
CREATE TABLE `eb_store_combination` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='拼团产品表';

-- ----------------------------
--  Records of `eb_store_combination`
-- ----------------------------
BEGIN;
INSERT INTO `eb_store_combination` VALUES ('1', '1', '0', 'http://datong.crmeb.net/public/uploads/attach/2019/01/15/5c3dba1366885.jpg', '[\"http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dba1366885.jpg\",\"http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dba4187461.jpg\",\"http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3db9de2b73a.jpg\"]', '3人团 无线吸尘器F8 玫瑰金礼盒版', '', '3', '年货节活动价1699元，领取吸尘器优惠券再减50元，到手价仅1649元', '1.00', '0', '12', '988', '1547554180', '1', '1', '0', '1', '0', '1', '1.00', '', '1546272000', '1551283200', '0', '0'), ('2', '3', '0', 'http://datong.crmeb.net/public/uploads/attach/2019/01/15/5c3dc0ef27068.jpg', '[\"http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dc0ef27068.jpg\",\"http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dc15ba1972.jpg\"]', '智米加湿器 白色', '', '6', '智米加湿器 白色', '199.00', '0', '0', '999', '1547554327', '1', '1', '0', '1', '0', '1', '0.00', '', '1546272000', '1551283200', '0', '0'), ('3', '2', '0', 'http://datong.crmeb.net/public/uploads/attach/2019/01/15/5c3dbc27c69c7.jpg', '[\"http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dbc27c69c7.jpg\",\"http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dbc6a38fab.jpg\"]', '智能马桶盖 AI版', '', '10', '智能马桶盖 AI版', '499.00', '0', '6', '994', '1547554596', '1', '1', '0', '1', '0', '1', '0.00', '', '1546272000', '1551283200', '0', '0');
COMMIT;
...
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='商品秒杀产品表';

-- ----------------------------
--  Records of `eb_store_seckill`
-- ----------------------------
BEGIN;
INSERT INTO `eb_store_seckill` VALUES ('1', '1', 'http://datong.crmeb.net/public/uploads/attach/2019/01/15/5c3dba1366885.jpg', '[\"http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dba1366885.jpg\",\"http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dba4187461.jpg\",\"http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3db9de2b73a.jpg\"]', '手慢无 无线吸尘器F8 玫瑰金礼盒版', '【年货节活动价1699元，领取吸尘器优惠券再减50元，到手价仅1649元】', '1.00', '100.00', '599.00', '1699.00', '1', '987', '13', '件', '0.00', '', '1546272000', '1551283200', '1547554098', '1', '1', '1', '0', '1', '1'), ('2', '3', 'http://datong.crmeb.net/public/uploads/attach/2019/01/15/5c3dc0ef27068.jpg', '[\"http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dc0ef27068.jpg\",\"http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dc15ba1972.jpg\"]', '智米加湿器 白色', '智米加湿器 白色', '99.00', '10.00', '249.00', '249.00', '0', '999', '1', '件', '0.00', '', '1546272000', '1551283200', '1547554239', '1', '1', '1', '0', '1', '1'), ('3', '2', 'http://datong.crmeb.net/public/uploads/attach/2019/01/15/5c3dbc27c69c7.jpg', '[\"http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dbc27c69c7.jpg\",\"http:\\/\\/datong.crmeb.net\\/public\\/uploads\\/attach\\/2019\\/01\\/15\\/5c3dbc6a38fab.jpg\"]', '智能马桶盖 AI版 限时秒杀中', '智能马桶盖 AI版', '599.00', '1500.00', '1599.00', '1999.00', '0', '994', '6', '件', '0.00', '', '1546272000', '1551283200', '1547554561', '1', '1', '1', '0', '1', '1');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `eb_system_admin` VALUES ('1', 'admin', '6b94a88632e2577a60f64520998d11c9', 'admin', '1', '123.139.68.43', '1547606312', '1547198693', '0', '0', '1', '0');
COMMIT;
...
CREATE TABLE `eb_system_attachment_category` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='附件分类表';

-- ----------------------------
--  Records of `eb_system_attachment_category`
-- ----------------------------
BEGIN;
INSERT INTO `eb_system_attachment_category` VALUES ('1', '0', '产品图', ''), ('2', '0', '分类图片', ''), ('3', '0', '广告图', '');
COMMIT;
...
CREATE TABLE `eb_system_config` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=99 DEFAULT CHARSET=utf8 COMMENT='配置表';
...
CREATE TABLE `eb_system_config_tab` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COMMENT='配置分类表';
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='通知记录表';
...
CREATE TABLE `eb_system_role` (
  ...
  PRIMARY KEY (`id`),
  KEY `status` (`status`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=24 DEFAULT CHARSET=utf8 COMMENT='身份管理表';
...
-- ----------------------------
BEGIN;
INSERT INTO `eb_user_group` VALUES ('1', '未分组'), ('2', '活跃用户'), ('3', '测试');
COMMIT;
...
CREATE TABLE `eb_wechat_news_category` (
  ...
  `add_time` varchar(255) NOT NULL COMMENT '添加时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=30 DEFAULT CHARSET=utf8 COMMENT='图文消息管理表';

-- ----------------------------
--  Records of `eb_wechat_news_category`
-- ----------------------------
BEGIN;
INSERT INTO `eb_wechat_news_category` VALUES ('21', '11', '0', '1', '51,52,58,59,60,150', '1542379262'), ('29', '测试', '0', '1', '1', '1547206341');
COMMIT;
...
CREATE TABLE `eb_wechat_template` (
  ...
  PRIMARY KEY (`id`),
  KEY `tempkey` (`tempkey`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT='微信模板';
