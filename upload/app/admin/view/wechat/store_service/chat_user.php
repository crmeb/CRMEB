                    ...
                    <table class="table table-striped  table-bordered">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <button class="btn btn-info btn-xs" type="button" onclick="window.location.href='{:Url('chat_list',array('id'=>$now_service['id'],'uid'=>$now_service['uid'],'to_uid'=>$vo['uid']))}'"><i class="fa fa-commenting-o"></i> 查看对话</button>
                            </td>
                        </tr>
                        {/volist}
                        </tbody>
