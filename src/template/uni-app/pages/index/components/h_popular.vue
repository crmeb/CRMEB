<template>
	<view :class="{borderShow:isBorader}">
		<view class='hotList' v-if="isShow && likeInfo.length">
			<view class='hot-bg'>
		...
		<view class='hotList' v-if="!isShow && isIframe && likeInfo.length">
			<view class='hot-bg'>
				<view class='title acea-row row-between-wrapper'>
					<view class='text line1'>
						<text class='label'>{{titleInfo[0].val}}</text>
		...
		<view class='hotList' v-if="isIframe && !likeInfo.length">
			<view class='hot-bg'>
				<view class='title acea-row row-between-wrapper'>
					<view class='text line1'>
						<text class='label'>{{titleInfo[0].val}}</text>
			...
			<view class='list acea-row row-middle'></view>
		</view>
	</view>
</template>
