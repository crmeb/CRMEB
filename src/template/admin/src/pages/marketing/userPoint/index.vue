                ...
                <Row :gutter="24" type="flex">
                    <Col :xl="6" :lg="10" :md="10" :sm="24" :xs="24">
                        <FormItem label="搜索：" label-for="store_name">
                            <Input search enter-button placeholder="请输入用户ID,标题" v-model="tableFrom.nickname" @on-search="userSearchs"/>
                        </FormItem>
                    </Col>
                    <Col :xl="6" :lg="10" :md="10" :sm="24" :xs="24">
                        <FormItem label="选择时间："  label-for="user_time">
                            <DatePicker :editable="false" clearable @on-change="onchangeTime" v-model="timeVal" :value="timeVal"  format="yyyy/MM/dd" type="daterange" placement="bottom-end" placeholder="选择时间" class="perW100"></DatePicker>
                        </FormItem>
                    </Col>
