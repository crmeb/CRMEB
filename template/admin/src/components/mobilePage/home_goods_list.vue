                        ...
                        <div class="item" :class="conStyle?'':'itemOn'" v-for="(item,index) in list" :index="index">
                            ...
                            <div class="info">
                                ...
                                <div class="price">
                                    ...
                                    <div class="label" :class="priceShow?'':'on'" v-if="item.couponId.length && couponShow">券</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="item" :class="conStyle?'':'itemOn'">
                            ...
                            <div class="info">
                                ...
                                <div class="price">
                                    ...
                                    <div class="label" :class="priceShow?'':'on'" v-if="couponShow">券</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <template v-if="itemStyle == 3">
                    <div class="listBig" v-if="list.length>0">
                        <div class="itemBig" :class="conStyle?'':'itemOn'" v-for="(item,index) in list" :key="index">
                            ...
                            <div class="name line2"><span class="coupon" v-if="item.couponId.length && couponShow">券</span><span  v-if="titleShow">{{item.store_name}}</span></div>
                            <div class="price"><span v-if="priceShow">￥<span class="num">{{item.price}}</span></span><span class="old-price" v-if="opriceShow">¥{{item.ot_price}}</span></div>
                        </div>
                    </div>
                    <div class="listBig" v-else>
                        <div class="itemBig" :class="conStyle?'':'itemOn'">
                            ...
                            <div class="name line2"><span class="coupon" v-if="couponShow">券</span><span  v-if="titleShow">商品名称</span></div>
                            <div class="price"><span v-if="priceShow">￥<span class="num">66.66</span></span><span class="old-price" v-if="opriceShow">¥99.99</span></div>
                        </div>
                    </div>
                </template>
            </div>
        ...
        .itemBig
            ...
            .img-box
                ...
                .label
                    ...
                    line-height 25px
                    text-align center
                    background: linear-gradient(270deg, #ff5400 0%, #f00 100%);
                    color #fff
                    font-size 12px
