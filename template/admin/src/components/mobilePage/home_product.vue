        ...
        <div class="home_product">
            ...
            <div class="hd_nav" :style="{justifyContent:titleConfig===0?'flex-start':titleConfig===1?'space-around':'flex-end'}"  v-else>
                <div class="item">
                    ...
                    <span class="label" :style="{ 'background': index==tabCur ? activeColor : '','color': index==tabCur ? '#fff' : '' }">标题简介</span>
                </div>
            </div>
            <div class="list-wrapper">
                <div class="item" v-for="(item,index) in list" :index="index">
                    <div class="img-box">
                        ...
                        <div class="label" v-if="item.activity && item.activity.type === '1'">秒杀</div>
                        <div class="label" v-if="item.activity && item.activity.type === '2'">砍价</div>
                        <div class="label" v-if="item.activity && item.activity.type === '3'">拼团</div>
                    </div>
                    <div class="info">
                        ...
                        <div class="price">
                            ...
                            <div class="label" :class="priceShow?'':'on'" v-if="couponShow && item.checkCoupon">券</div>
                        </div>
                    </div>
                </div>
            </div>
