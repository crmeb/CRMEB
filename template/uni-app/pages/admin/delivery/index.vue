			...
			<block v-if="logistics.length>0">
				<view class="list" v-show="active === 0">
					...
					<block v-if="curExpress == 1">
						...
						<view class="item acea-row row-between-wrapper" style="font-size: 25rpx;">
							<view class="tip">顺丰请输入单号：收件人或寄件人手机号后四位,</view>
							<view class="tip">例如：SF000000000000:3941</view>
						</view>
					</block>
